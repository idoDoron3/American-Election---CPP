...
#ifndef AMERICANELECTIONS_REPUBLICSOCIALPOLITICIAN_H
#define AMERICANELECTIONS_REPUBLICSOCIALPOLITICIAN_H
#include "Politician.h"
class RepublicSocialPolitician: public Politician{
public:
    /* Constructor
    * inputs: name, last name, id, and power
    * the function creates new Republic social Politician base on politician constructor
    * return: no return value*/
    RepublicSocialPolitician(string first_n, string last_n, int id, int power): Politician(first_n, last_n, id, power){};
      /* Destructor
       * inputs:
       * the function destroy Politician object
       * return: no return value*/
    virtual ~RepublicSocialPolitician(){};
    /* inputs:
    * the function return the politician power in case of elections.
    * return: int represent the politician power*/
    virtual int getElectionPower(){return this->power*2;};
    /* inputs:
    * the function return the politician power in case of primaries.
    * return: int represent the politician power*/
    virtual int getPrimariesPower(){return -1;};
    /* inputs:
...
#endif //AMERICANELECTIONS_REPUBLICSOCIALPOLITICIAN_H
