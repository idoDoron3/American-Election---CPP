...
#ifndef AMERICANELECTIONS_DEMOCRATICSOCIALPOLITICIAN_H
#define AMERICANELECTIONS_DEMOCRATICSOCIALPOLITICIAN_H
#include "Politician.h"
class DemocraticSocialPolitician: public Politician{
public:
    /* Constructor
    * inputs: name, last name, id, and power
    * the function creates new democratic social Politician base on politician constructor
    * return: no return value*/
    DemocraticSocialPolitician(string first_n, string last_n, int id, int power): Politician(first_n, last_n, id, power){};
    /* Destructor
     * inputs:
...
#endif //AMERICANELECTIONS_DEMOCRATICSOCIALPOLITICIAN_H
